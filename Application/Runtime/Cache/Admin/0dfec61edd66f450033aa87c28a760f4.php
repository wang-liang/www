    ...
    <form class="form form-horizontal" action="/index.php/admin/login/login" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img style="cursor:pointer;" onclick="this.src='<?php echo U('chkcode');?>#'+Math.random()" src="<?php echo U('chkcode');?>"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          <label for="online">
      ...
      <div class="row">
        <div class="formControls col-8 col-offset-3">
          <input name="ac" type="submit" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
          <input name="ac" type="reset" class="btn btn-default radius size-L" value="&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;消&nbsp;">
        </div>
      </div>
    </form>
  </div>
